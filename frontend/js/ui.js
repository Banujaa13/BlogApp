// frontend/js/ui.js
// Shared UI helpers: password visibility toggle
...
function eyeIcon() {
    return `<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
function blogLogoIcon() {
    return `<span class="logo-icon" aria-hidden="true">
